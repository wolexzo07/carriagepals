...
<body>
	   <script>
			function response_sh(){
				window.location="./?pay_messages=Wallet was topped-up successful";
			}
			function response_frd(){
				window.location="./?pay_messages=Fraudulent transaction detected";
			}
			function response_dp(){
				window.location="./?pay_messages=Failed to top-up wallet! Duplicate Transaction.";
			}
			function response_fl(){
				window.location="./?pay_messages=Failed to top-up wallet! Failed Transaction.";
			}
		</script>
<?php
				...
				curl_setopt_array($curl, array(
				  ...
				  if(($status=="success"))
				  {
					  ...
					  if($amountCharged >= $amountToPay){
							...
							echo "<script>response_frd();</script>";
